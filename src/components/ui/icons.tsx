/**
 * Inline stroke icons, sized by className and coloured by `currentColor`.
 *
 * Inline rather than a package: the set is small, this avoids a dependency and
 * a runtime lookup, and every glyph inherits text colour so it stays correct
 * across the theme automatically. Each is decorative — the surrounding element
