          ...
          {rules.length === 0 ? (
            ...
            <ol className="mt-3 grid gap-2 sm:grid-cols-2">
              {rules.map((rule, index) => (
                <li
                  key={index}
                  className="flex gap-2.5 well rounded-2xl px-3.5 py-2.5 text-[13.5px] leading-relaxed text-ink-700 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.9)]"
                >
                  <span className="mt-px shrink-0 font-bold tabular-nums text-brand-300">
